    ...
    <section className="mt-80">
      <div className="w-full p-8 dark:bg-dark-800 border-2 border-[#222] rounded-sm flex lg:flex-row flex-col justify-between gap-8">
        ...
        <div>
          ...
          <p>
            Me chamo Lucas, moro em Curitiba e sou programador desde os meus 17
            anos. Comecei demonstrando interesse em python, mas quando conheci o
            desenvolvimento de sites e sistemas, migrei imediatamente para essa
            área. Atualmente estou cursando Ciências da Computação na PUCPR,
            porém sempre mantendo os estudos por fora.
          </p>
